...
export const TripHeader = ({ trip }: TripHeaderProps) => {
  return (
    <div className="flex flex-col">
      ...
      <div className="hidden lg:grid grid-cols-[2fr,1fr,1fr] gap-2 grid-rows-2 lg:order-2 lg:p-5">
      ...
      <div className="flex flex-col p-5 lg:order-1">
        ...
        <div className="flex items-center gap-1 my-1">
          ...
          <p className="text-xs text-grayPrimary lg:text-base">{trip.location}</p>
        </div>
